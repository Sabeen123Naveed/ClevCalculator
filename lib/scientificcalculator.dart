...
class _ScientificCalculatorState extends State<ScientificCalculator> {
  ...
  void _scientificOperands(value) {
    setState(() {
      ...
      if (value ==  AbSOLUTE_VALUE) value = 'abs';
      if (value == ARCSIN_SIGN) value = 'arcsin';
      if (value == ARCCOS_SIGN) value = 'arccos';
      if (value == ARCTAN_SIGN) value = 'arctan';
      if (value == ARCSINH_SIGN) value = 'arcsinh';
      if (value == ARCCOSH_SIGN) value = 'arccosh';
      if (value == ARCTANH_SIGN) value = 'arctanh';
  ...
  void _scientificResult() {
    setState(() {
      ...
      expression = expression.replaceAll(ARCSINH_SIGN, 'arcsinh');
      expression = expression.replaceAll(ARCCOSH_SIGN, 'arccosh');
      expression = expression.replaceAll(ARCTANH_SIGN, 'arctanh');
      expression = expression.replaceAll(LG_SIGN, 'log');
      expression = expression.replaceAll( AbSOLUTE_VALUE, 'abs');
