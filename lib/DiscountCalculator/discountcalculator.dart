                    ...
                    Row(
                      children: [
                        Expanded(child: Container(
                          height: 47,
                          color: Colors.white,
                          child: Center(child: Text("Original Price", style: TextStyle(fontSize: 18),)),
                        ),
                        ),
                        SizedBox(width: 2,),
                        Expanded(
                    ...
                    Row(
                      children: [
                        Expanded(child: Container(
                          height: 47,
                          color: Colors.white,
                          child: Center(child: Text("Discount Percent", style: TextStyle(fontSize: 18))),
                        ),
                        ),
                        SizedBox(width: 2,),
                        Expanded(
                    ...
                    Row(
                      children: [
                        Expanded(child: Container(
                          height: 47,
                          color: Colors.white,
                          child: Center(child: Text("Amount Saved", style: TextStyle(fontSize: 18))),
                        ),
                        ),
                        SizedBox(width: 2,),
                        Expanded(
                            child: Container(
                              height: 47,
                              color: Colors.white,
                              child: Center(child: Text("$amountSaved", style: TextStyle(fontSize: 20),)),
                            )
                        )
                      ],
                    ),
                    ...
                    Row(
                      children: [
                        Expanded(child: Container(
                          height: 47,
                          color: Colors.white,
                          child: Center(child: Text("Final Price", style: TextStyle(fontSize: 18))),
                        ),
                        ),
                        SizedBox(width: 2,),
                        Expanded(
                            child: Container(
                              height: 47,
                              color: Colors.white,
                              child: Center(child: Text("$finalPrice", style: TextStyle(fontSize: 20),)),
                            )
                        )
                      ],
                    ),
